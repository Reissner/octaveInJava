...
public class OctaveBoolean implements OctaveType {
    ...
    private void resizework(final int smallest_dim, final int[] pos) {
        ...
        if (data.length < neededSize) {
            final boolean[] newdata = new boolean[neededSize * 2];
            ...
            while (src_offset > 0) {
                ...
                Arrays.fill(data, dest_offset + blocksize, dest_offset + stride, false);
                src_offset -= blocksize;
                dest_offset -= stride;
            }
        }
    ...
    public boolean equals(final Object obj) {
        ...
        final OctaveBoolean other = (OctaveBoolean) obj;
